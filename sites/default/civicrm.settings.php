...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://db:db@db:3306/db?new_link=true');
}

// Additional settings generated by installer:
$civicrm_paths['civicrm.files']['url'] = 'https://drupal-site-d9.ddev.site//sites/default/files/civicrm';
$civicrm_paths['civicrm.files']['path'] = '/var/www/html/sites/default/files/civicrm';
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'https://drupal-site-d9.ddev.site');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'UvlRA2O56v4Lk3XxJIt1tv3akbEGEhSbM4obf2kBXg');
}
...
if (!defined('CIVICRM_CRED_KEYS') ) {
  define( '_CIVICRM_CRED_KEYS', 'aes-cbc:hkdf-sha256:p3pjMlnWEMYHxwn13plGRvut6BT0pJcFclCfJouKvYfWZFFdQ');
...
if (!defined('CIVICRM_SIGN_KEYS') ) {
  define( '_CIVICRM_SIGN_KEYS', 'jwt-hs256:hkdf-sha256:rqsAkQwrQcMcJxOzei8n7Jp47C6dR5mYwvW5IR9z0a3eGCTpxL3LA');
